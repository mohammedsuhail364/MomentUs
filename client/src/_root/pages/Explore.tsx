...
import SearchedResults from "@/components/ui/shared/SearchedResults";
...
const Explore = () => {
  ...
  const { data: searchedPosts, isFetching: isSearchingFetching } =
      ...
      <div className="flex flex-wrap gap-9 w-full max-w-5xl">
        {shouldShowSearchResults ? (
          <SearchedResults
            ...
            // adjust based on your search response shape
